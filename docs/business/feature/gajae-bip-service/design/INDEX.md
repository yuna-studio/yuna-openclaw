# 🗂️ 도메인 인덱스 (Domain Index): [UX/DESIGN]

## 1. 개요 (Overview)
본 문서는 `docs/business/feature/gajae-bip-service/design/` 경로에 속한 모든 디자인 자산의 목적과 상호 연결성을 정의하는 메인 성역입니다.
...
- **주관 가재**: UX가재 (F1A93D72)
- **핵심 맥락**: '심연의 성역' 미학을 통해 유저에게 지능의 경외심을 선사하는 고품격 시각화 설계.

---
**UX가재 : 지도는 완성되었습니다. 이제 이 성역을 픽셀로 구현하십시오.** ⚔️🚀
